@echo off
title Bijari 4K - Desenvolvimento
echo ========================================
echo   Bijari 4K - Matriz 2x2 - DESENVOLVIMENTO
echo ========================================
echo.
...
echo.
echo Modo desenvolvimento - com logs detalhados
echo.
...
echo.
echo Iniciando sistema 4K em modo desenvolvimento...
echo.
echo CONTROLES:
echo - CTRL+Q: Sair do sistema
echo - O VLC sera mantido sempre em foco automaticamente
echo - Logs detalhados serao exibidos
echo.

REM Executa o sistema 4K com logs detalhados
python -u video_sync_4k.py
