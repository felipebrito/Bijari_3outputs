@echo off
title Corrigir Problema do psutil
echo ========================================
echo   Corrigir Problema do psutil
echo ========================================
echo.
echo Este script vai tentar corrigir o problema do psutil
echo que precisa de compilacao no Windows.
echo.
...
echo.
echo Agora voce pode executar o sistema normalmente.
